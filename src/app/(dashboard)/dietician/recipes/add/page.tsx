...
export default function AddRecipePage() {
    ...
    // Also strips leading bullets/dashes/numbers if user copy-pasted them
    ...
    // Strings ending with ':' become bold section headers without bullets
    ...
    // Handle editing the formatting string directly (two-way sync)
