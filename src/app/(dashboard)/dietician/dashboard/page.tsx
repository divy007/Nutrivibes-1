            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
              ...
              <div className="flex bg-slate-100/80 p-1 rounded-2xl border border-slate-200/50">
                <button
                  ...
                  className={`px-4 py-2 rounded-xl text-xs font-black uppercase tracking-wider transition-all cursor-pointer ${activeTab === 'followup' ? 'bg-brand-sage text-white shadow-sm' : 'text-slate-500 hover:text-slate-800'
                    }`}
                >
                ...
                <button
                  ...
                  className={`px-4 py-2 rounded-xl text-xs font-black uppercase tracking-wider transition-all cursor-pointer ${activeTab === 'pending' ? 'bg-brand-sage text-white shadow-sm' : 'text-slate-500 hover:text-slate-800'
                    }`}
                >
