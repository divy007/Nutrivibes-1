...
export default function DieticianDashboard() {
  ...
  return (
    <div className="bg-[#FAF9F6] min-h-full pb-10">
      ...
      {/* Main Container with Sticky Right Sidebar */}
      <div className="p-6 flex flex-col lg:flex-row gap-6 max-w-[1800px] mx-auto">
        ...
        <div className="flex-1 space-y-6 min-w-0">
          ...
          {/* Row 1: Welcome Greeting & Date Widget */}
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            {/* Welcome & Quick Actions (Spans 3 cols) */}
            <div className="col-span-1 md:col-span-3 bg-gradient-to-br from-brand-forest to-brand-sage text-white rounded-[32px] p-8 relative overflow-hidden soft-shadow flex flex-col justify-between min-h-[220px]">
          ...
          {/* Row 2: Metrics Summary Grid (5 column bento grid) */}
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
            ...
            <Link href="/dietician/clients?status=LEADS" className="block">
              <SummaryCard
                title="Leads (Incomplete)"
          ...
          {/* Row 3: Daily Tasks Card & Area Analytics Card */}
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            
            {/* Daily Tasks Bento Box */}
            <div className="bg-white rounded-[32px] border border-slate-100 p-6 soft-shadow flex flex-col min-h-[450px] relative overflow-hidden group">
            ...
            <div className="bg-white rounded-[32px] border border-slate-100 p-6 soft-shadow flex flex-col min-h-[450px]">
        ...
        {/* Right Sidebar - Sticky Activity Live Feed */}
        <div className="hidden lg:block lg:w-[320px] 2xl:w-[380px] flex-shrink-0 lg:sticky lg:top-6 lg:h-[calc(100vh-3rem)]">
          <ActivityFeed />
        </div>
